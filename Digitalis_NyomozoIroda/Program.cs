namespace Digitalis_NyomozoIroda
{
    internal class Program
    {
        static void Main(string[] args)
        {
			...
			Bizonyíték b = new Bizonyíték("FEGYVER1","kamerafelvétel");
			Felhasználó nyomozó = new Felhasználó("Bendős Dávid","IEA38234","Nyomozó");
            Ügy boltibünügy = new Ügy("IEZD2393672","Sarki bolti rablás","Délután 5-kor kettő lőfegyverrel rendelkező maszkos féri 20.000ft értékben tulajdonított el árut a sakri boltbol.","folyamatban");
